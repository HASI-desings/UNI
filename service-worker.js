...
const CACHE_NAME = 'parallax-v5';
const CORE_FILES = ['/', '/index.html', '/css/styles.css', '/js/config.js', '/js/app.js', '/js/hero-carousel.js', '/js/supabase-client.js', '/js/math-engine.js', '/js/notifications.js', '/manifest.json', '/offline.html'];
